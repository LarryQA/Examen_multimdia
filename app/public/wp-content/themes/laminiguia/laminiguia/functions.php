<?php
/**
 * LaMiniguia functions and definitions
 *
 ...
 */
function laminiguia_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on LaMiniguia, use a find and replace
		* to change 'laminiguia' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'laminiguia', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'laminiguia_custom_background_args',
			array(
 ...
 */
function laminiguia_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'laminiguia_content_width', 640 );
}
add_action( 'after_setup_theme', 'laminiguia_content_width', 0 );
 ...
 */
function laminiguia_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'laminiguia' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'laminiguia' ),
...
add_action( 'widgets_init', 'laminiguia_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'laminiguia_scripts' );
